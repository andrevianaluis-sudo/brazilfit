...
// All clients summary
// GET /pt/progress-summary — all active clients with their full progress history
...
// POST /pt/clients/:id/add-oneoff — add a single one-off session, drop the last upcoming to keep block at 10
