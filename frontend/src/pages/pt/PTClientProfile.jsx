...
export default function PTClientProfile() {
  ...
  const tabs = ['overview', 'sessions', 'cancellations', 'progress', 'photos', 'diary', 'notes', 'messages', 'blocks', 'checkins', 'onboarding', 'assessment', 'programme', 'workouts'];
  const tabLabels = { overview:'Overview', sessions:'Sessions', cancellations:'Cancels', progress:'Progress', photos:'Photos', notes:'Notes', messages:'Messages', blocks:'Blocks', checkins:'Check-ins', diary:'Food Diary', onboarding:'Onboard', assessment:'Assessment', programme:'Programme', workouts:'Workouts' };
  ...
  return (
    <div style={{animation:"fadeIn 0.3s ease"}}>
      ...
      {/* Tabs */}
      <div style={{display:"flex",borderBottom:"1px solid rgba(255,255,255,0.1)",overflowX:"auto",WebkitOverflowScrolling:"touch",scrollbarWidth:"none",msOverflowStyle:"none",position:"sticky",top:0,backgroundColor:"#000",zIndex:10}}>
        {tabs.map(tab => (
          <button
            key={tab}
