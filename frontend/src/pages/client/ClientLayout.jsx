            ...
            return (
              <button key={item.to} onClick={() => { navigate(item.to); setSidebarOpen(false); }}
                style={{
                  ...
                  minHeight: 'auto', transition: 'all 0.15s ease', fontFamily: "'DM Sans', system-ui",
                }}
                  ...
                  <div style={{ maxHeight: '380px', overflowY: 'auto' }}>
                    {notifications.length === 0 ? (
                      ...
                      <div
                        key={n.id}
                        onClick={() => {
                          if (n.type === 'message') { navigate('/client/messages'); setShowNotifs(false); }
                          else if (['session','reinstate','cancellation'].includes(n.type)) { navigate('/client/sessions'); setShowNotifs(false); }
                        }}
