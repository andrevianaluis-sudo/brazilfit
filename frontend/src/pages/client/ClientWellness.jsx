        ...
        {tab==="rest_day"?(
          <div>
            ...
            <div style={{display:"flex",flexDirection:"column",gap:12}}>
              {[
                { emoji:'', title:'Morning Wake-Up Flow', tag:'10 min', level:'Beginner', color:YELLOW, bg:'rgba(255,214,0,0.08)', border:'rgba(255,214,0,0.2)', desc:'Gentle head-to-toe movement to ease your body out of sleep. Neck rolls, spinal twist, quad stretch, forward fold.', keywords:['neck','back','spine','hip','hamstring'] },
