...
function MindfulnessPlayer({ session, onClose }) {
  ...
  return (
    <div style={{position:'fixed',inset:0,zIndex:50,backgroundColor:'#111',display:'flex',flexDirection:'column',alignItems:'center',padding:'2rem 1.25rem 2rem',overflowY:'auto'}}>
      ...
      <div style={{position:'relative',width:'140px',height:'140px',marginBottom:'1.5rem',flexShrink:0}}>
      ...
      <div style={{textAlign:'center',maxWidth:'480px',minHeight:'100px',marginBottom:'1.5rem'}}>
        {isDone?(
          ...
          <div style={{opacity:fadeIn?1:0,transform:fadeIn?'scale(1)':'scale(0.95)',transition:'all 0.8s ease'}}>
            ...
            <p style={{fontFamily:"'Clash Display',system-ui",fontSize:'1.5rem',fontWeight:300,color:TEXT,lineHeight:1.4,margin:'0 0 0.75rem',letterSpacing:'-0.01em'}}>{steps[currentStepIdx]}</p>
      ...
      <div style={{maxWidth:'800px',margin:'0 auto',padding:'2rem 1.25rem'}}>
        ...
        <div style={{display:'flex',alignItems:'flex-start',justifyContent:'space-between',margin:'1.25rem 0 1.5rem'}}>
          ...
          {isPro?(
            ...
            <button onClick={()=>navigate('/client/upgrade')} style={{display:'flex',alignItems:'center',gap:'4px',fontSize:'0.72rem',fontWeight:700,color:YELLOW,border:`1px solid ${YELLOW}44`,borderRadius:'20px',padding:'4px 12px',background:'none',cursor:'pointer',minHeight:'auto'}}>
